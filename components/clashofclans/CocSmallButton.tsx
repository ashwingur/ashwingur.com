...
const CocSmallButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`${className} ${outerColour} clash-font-style relative z-0 rounded-xl border-2 border-black p-1 transition-all hover:text-sm`}
    >
      ...
      <div className="absolute left-0 right-0 top-0 z-[-1] flex h-[50%] w-full">
        <div
          className={innerColour + " mx-1 mt-1 h-full w-full rounded-lg"}
        ></div>
      </div>
