...
const ProgressPage = () => {
  ...
  if (data === null || data.data.length == 0) {
    return CocLoadingOrError({
      heading: "",
      info: <p className="coc-font-style m-8 text-center text-2xl">No data</p>,
    });
  }
  ...
  const NumericCategory = (numericCategoryProps: NumericCategoryProps) => {
    const nameKeys = numericCategoryProps.names.map((name, index) => {
      return (
        <div
          className={`rounded-md p-2 transition-all hover:cursor-pointer hover:bg-black md:text-lg`}
          key={index}
          onClick={() => {
            itemClick(index);
    ...
    return (
      <div
        className={`${numericCategoryProps.className} coc-font-style flex w-full flex-col items-center rounded-md border-2 border-black px-4 py-2`}
      >
  ...
  const RootCategory = (rootCategoryProps: RootCategoryProps) => {
    ...
    return (
      <div
        className={`${rootCategoryProps.className} coc-font-style flex w-full flex-col items-center rounded-md border-2 border-black px-4 py-2`}
      >
  ...
  return (
    <div className="bg-clash">
      ...
      <div className="flex flex-col items-center">
        <div className="mx-auto flex flex-col items-center gap-4 pt-28 md:flex-row">
        ...
        <h2 className="clash-font-style mb-1 mt-12 text-center text-2xl font-thin">
          {selectedStatistic}
        </h2>
      </div>
