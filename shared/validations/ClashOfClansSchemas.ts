...
const CwlWarRoundSchema = z.object({
  clan: z.string(),
  clan_tag: z.string(),
  clan_attacks: z.number().default(0),
  clan_stars: z.number().default(0),
  clan_destruction_percentage: z.number().default(0),
  opponent: z.string(),
  opponent_tag: z.string(),
  opponent_attacks: z.number().default(0),
  opponent_stars: z.number().default(0),
  opponent_destruction_percentage: z.number().default(0),
  state: z.string(),
  war_tag: z.string(),
});
